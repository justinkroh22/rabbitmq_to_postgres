...
def callback(ch, method, properties, body):
    ...
    try:
        ...
        postgres_insert_query = """ INSERT INTO leads (registration_dttm, id, first_name, last_name, email, gender, ip_address, cc, country, birthdate, salary, title, comments) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"""
        ...
        print (count, "Record inserted successfully into leads table")

    except (Exception, psycopg2.Error) as error :
        if(connection):
            print("Failed to insert record into leads table", error)
